"""Embedded ArtemisServer helpers for CLI ops that need a live runtime."""
...
from artemis.infra.agents.providers.probe import probe_provider_row
...
async def probe_provider_async(provider_id: int, *, model_id: str | None = None) -> dict[str, Any]:
    from artemis.cli.support.db import open_cli_services, resolve_cli_locale
