"""Embedded ArtemisServer chat runtime via the CLI gateway channel."""
...
from artemis.infra.gateway.cli.turn import build_cli_inbound, prepare_cli_turn
...
def resolve_embedded_user_id(
    ...
    *,
    ...
    from artemis.cli.support.ctx import resolve_user
    from artemis.cli.support.state import default_state_path, load
    from artemis.infra.users.acting import resolve_acting_user_id
...
class CliChatSession:
    ...
    def __init__(self, server: ArtemisServer, *, user_id: int) -> None:
