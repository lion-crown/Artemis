"""artemis skills — per-agent skill library."""
...
def list_skills(agent_id: str | None) -> None:
    ...
    from artemis.cli.support.skills import list_skills_offline
...
def config_skills(agent_id: str | None) -> None:
    ...
    from artemis.cli.support.skills import list_skills_offline, set_skill_enabled
    from artemis.infra.errors import ArtemisError
