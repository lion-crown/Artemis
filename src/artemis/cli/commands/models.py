"""artemis models — provider presets and resolved model list."""
...
def presets() -> None:
    ...
    from artemis.cli.support.offline_ops import load_provider_presets_offline
...
def list_models() -> None:
    ...
    from artemis.cli.support.ctx import json_output_enabled
    from artemis.cli.support.offline_ops import list_resolved_models_offline
...
def active_model(provider_name: str | None, model_id: str | None) -> None:
    ...
    from artemis.cli.support.offline_ops import get_active_model_offline, set_active_model_offline
...
def config_models() -> None:
    ...
    from artemis.cli.support.embedded_ops import probe_provider
...
def ollama_list() -> None:
    ...
    from artemis.cli.support.ctx import json_output_enabled
    from artemis.infra.utils.ollama_manager import OllamaModelManager
