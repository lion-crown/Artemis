...
def overview() -> None:
    ...
    from artemis.cli.support.offline_ops import admin_overview_offline
...
def audit(actor: str | None, action: str | None, limit: int) -> None:
    ...
    from artemis.cli.support.offline_ops import admin_audit_offline
...
def list_admin_providers() -> None:
    from artemis.cli.support.offline_ops import list_providers_offline
...
def create_admin_provider(name: str, kind: str, config_json: str) -> None:
    ...
    from artemis.cli.support.offline_ops import create_provider_offline
...
def delete_admin_provider(provider_id: str) -> None:
    from artemis.cli.support.offline_ops import delete_provider_offline
...
def rotate_jwt_secret() -> None:
    ...
    click.echo("jwt secret rotated. Restart artemis-server for new sessions.")
