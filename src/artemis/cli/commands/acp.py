"""`artemis acp` — run an Artemis agent as an ACP server over stdio."""
...
def acp_cmd(agent_id: str | None, debug: bool) -> None:
    """Start Artemis as an ACP agent (stdio) for IDE clients (Zed, OpenCode, …)."""
    from artemis.cli.support.ctx import resolve_agent
