...
def list_jobs(agent_id: str | None, as_user: str | None) -> None:
    ...
    from artemis.cli.support.offline_ops import list_cron_offline, resolve_cron_user_id
...
def create_job(
    ...
    """Create a cron job."""
    from artemis.cli.support.offline_ops import create_cron_offline, resolve_cron_user_id
    ...
    click.echo("hint: restart `artemis run` to load new cron jobs into the running server.")
...
def delete_job(agent_id: str | None, cron_id: str, as_user: str | None) -> None:
    """Delete a cron job."""
    from artemis.cli.support.offline_ops import delete_cron_offline, resolve_cron_user_id
...
def run_now(agent_id: str | None, cron_id: str, as_user: str | None) -> None:
    ...
    from artemis.cli.support.embedded_ops import cron_run_now
