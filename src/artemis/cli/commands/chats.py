"""artemis chats — thread CRUD + interactive REPL (CLI channel / local DB)."""
...
from artemis.cli.support.ctx import json_output_enabled, require_agent
...
def _run_turn(
    ...
    *,
    ...
    from artemis.cli.repl.render import ChunkRenderer
    from artemis.cli.repl.runtime import run_chat_turn_async
    from artemis.cli.repl.turn import ChatTurnResult
...
def list_chats(agent_id: str | None, as_user: str | None, limit: int) -> None:
    ...
    from artemis.cli.support.db import list_threads_offline
...
def get_chat(thread_id: str, agent_id: str | None, as_user: str | None, limit: int) -> None:
    ...
    from artemis.cli.support.embedded_ops import fetch_thread_history
    from artemis.cli.support.offline_ops import resolve_cron_user_id
...
def create_chat(agent_id: str | None, as_user: str | None) -> None:
    ...
    from artemis.cli.support.offline_ops import create_thread_offline, resolve_cron_user_id
    from artemis.infra.errors import ArtemisError
...
def update_chat(
    ...
    aid = require_agent(agent_id)
    from artemis.cli.support.offline_ops import resolve_cron_user_id, update_thread_offline
    from artemis.infra.errors import ArtemisError
...
def delete_chat(thread_id: str, agent_id: str | None, as_user: str | None, yes: bool) -> None:
    """Delete a thread."""
    from artemis.cli.support.offline_ops import delete_thread_offline, resolve_cron_user_id
    from artemis.infra.errors import ArtemisError
...
def repl(
    ...
    from artemis.cli.repl.embedded_session import embedded_chat_server
    from artemis.cli.repl.render import print_slash_help, print_welcome
    from artemis.cli.repl.runtime import (
        CliChatSession,
        resolve_embedded_user_id,
    )
    from artemis.cli.repl.session import ReplSession
    from artemis.cli.repl.toolbar import format_repl_toolbar
