...
from artemis.infra.auth.sso.discovery import DiscoveryCache
from artemis.infra.auth.sso.id_token import verify_id_token
from artemis.infra.auth.sso.pkce import new_pkce_pair
from artemis.infra.auth.sso.public_base import build_redirect_uri
from artemis.infra.auth.sso.redirect_after import sanitize_redirect_after
from artemis.infra.db.repos.secrets import SecretRepo
from artemis.infra.db.repos.sso import SsoProviderRow
    ...
    def put_config(
        ...
        *,
        ...
        provider = self._services.sso_repo.upsert_provider(
            ...
            display_name=self._string(body, "display_name", current, "Artemis SSO"),
