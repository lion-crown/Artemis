...
from artemis.infra.db.pool import DatabasePool
from artemis.infra.db.repos.agents import AgentRepo
from artemis.infra.db.repos.audit import AuditRepo
from artemis.infra.db.repos.backends import BackendRepo
from artemis.infra.db.repos.care_push import CarePushRepo
from artemis.infra.db.repos.channels import ChannelRepo
from artemis.infra.db.repos.connectors import ConnectorRepo
from artemis.infra.db.repos.cron import CronJobRepo
from artemis.infra.db.repos.invites import InviteRepo
from artemis.infra.db.repos.knowledge import KnowledgeRepo
from artemis.infra.db.repos.proactive_care_config import ProactiveCareConfigRepo
from artemis.infra.db.repos.providers import ProviderRepo
from artemis.infra.db.repos.published_experts import PublishedExpertRepo
from artemis.infra.db.repos.secrets import SecretRepo
from artemis.infra.db.repos.sessions import SessionRepo
from artemis.infra.db.repos.settings import SettingsRepo
from artemis.infra.db.repos.skill_packages import SkillPackageRepo
...
from artemis.infra.db.repos.usage import UsageRepo
from artemis.infra.db.repos.user_policies import UserPolicyRepo
from artemis.infra.db.repos.users import UserRepo
from artemis.infra.db.repos.voice_providers import VoiceProviderRepo
...
def build_shared_services(
    *, db: DatabasePool, paths: PathLayout, config: ArtemisConfig
) -> SharedServices:
