...
**not** :class:`~artemis.infra.gateway.media.ingress.AgentBackedMediaBackend` (IM ingress).
"""
...
from artemis.infra.gateway.media.inbound_store import display_name_from_stored
