...
Usage:
    python -m artemis.infra.gateway.bot_creators.feishu_bot_creator init
    python -m artemis.infra.gateway.bot_creators.feishu_bot_creator create [--platform feishu|lark]
    python -m artemis.infra.gateway.bot_creators.feishu_bot_creator cleanup
"""
...
_PLATFORM_CONFIGS = {
    "feishu": {
        ...
        "default_greeting": "Hi，我是你刚刚使用 Artemis 创建的飞书机器人，你现在可以跟我聊天了！",
        "app_desc": "由 Artemis 一键创建的飞书机器人",
        "state_file_prefix": "artemis-feishu-bot",
    },
    "lark": {
        "open_base": "https://open.larksuite.com",
        "accounts_domain": "https://accounts.larksuite.com",
        "lark_domain": "https://accounts.larksuite.com",
        "default_greeting": "Hi, I'm the bot you just created with Artemis. You can chat with me now!",
        "app_desc": "Lark bot created by Artemis",
        "state_file_prefix": "artemis-lark-bot",
    },
}
