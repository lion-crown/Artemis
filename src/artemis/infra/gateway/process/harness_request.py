...
from artemis.i18n.domains.attachment import attachment_empty_image, attachment_empty_message
...
from artemis.infra.gateway.process.message_keys import images_from_message
from artemis.infra.utils.locale import Locale, normalize_locale
...
def _build_content_sync(
    *,
    ...
    from artemis.infra.gateway.media.attachment_hints import make_image_url_block  # noqa: PLC0415
    ...
    *,
    ...
    if messages is not None:
        ...
        if reasoning_overrides:
            configurable["artemis_reasoning_overrides"] = reasoning_overrides
        if configurable:
