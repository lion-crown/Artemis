...
COMPOSER_CTX_KEY = "artemis_composer_context"
INBOUND_ATTACHMENTS_KEY = "artemis_inbound_attachments"
...
STREAM_ERROR_FLAG = "artemis_stream_error"
...
def resolve_user_id_for_message(
    ...
    *,
    ...
    """Resolve Artemis ``users.id`` for thread/session persistence.

    Dashboard and CLI use numeric ``subject_id`` values as Artemis user ids.
