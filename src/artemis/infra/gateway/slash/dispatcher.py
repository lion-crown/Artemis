...
from artemis.infra.gateway.slash.catalog import SlashCommandSpec, list_specs, spec_for
from artemis.infra.gateway.slash.ctx import SlashCtx
from artemis.infra.gateway.slash.runtime_bridge import build_runtime_ctx
...
class SlashDispatcher:
    ...
    def known(self) -> list[tuple[str, str]]:
        from artemis.infra.gateway.slash.catalog import CATALOG  # noqa: PLC0415
...
def build_default_dispatcher() -> SlashDispatcher:
    from artemis.infra.gateway.slash.handlers import register_all  # noqa: PLC0415
