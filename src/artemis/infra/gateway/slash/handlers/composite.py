...
from artemis.i18n.domains.agents import agent_error_message
from artemis.i18n.domains.slash import localized_rows, tr
from artemis.infra.gateway.slash.ctx import SlashCtx, ensure_thread_id, lang_of
from artemis.infra.gateway.slash.formatting import (
    format_duration,
...
async def cmd_status(d: SlashDispatcher, cmd: SlashCommand, ctx: SlashCtx, sink: SlashSink) -> None:
    ...
    from artemis.i18n.domains.agents import agent_state_label  # noqa: PLC0415
    ...
    rows: list[tuple[str, str]] = [
        ("artemis", ctx.artemis_version or tr("unknown", lang)),
