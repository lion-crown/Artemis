...
class BackupManifest:
    ...
    def to_json(self) -> str:
        payload: dict[str, Any] = {
            ...
            "artemis_version": self.artemis_version,
    ...
    def from_dict(cls, data: dict[str, Any]) -> BackupManifest:
        ...
        return cls(
            ...
            artemis_version=str(data.get("artemis_version", "")),
            schema_version=int(data.get("schema_version", 0)),
            created_at=str(data.get("created_at", "")),
            home=str(data.get("home", "")),
            db_file=str(data.get("db_file", "db/artemis.db")),
            ...
            # Older archives never packed ~/.artemis/plugins; missing key means omit on restore.
            includes_plugins=(
                bool(data["includes_plugins"]) if "includes_plugins" in data else False
            ),
            # Older archives never packed ~/.artemis/knowledge.
            includes_knowledge=(
