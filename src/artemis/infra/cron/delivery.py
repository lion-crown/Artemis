...
from artemis.infra.cron.task_type import CronTaskType, normalize_cron_task_type
from artemis.infra.gateway.process import build_harness_request
from artemis.infra.gateway.process.history_projection import TurnHistoryTracker, message_inputs
from artemis.infra.gateway.process.message_keys import COMPOSER_CTX_KEY, build_composer_context
...
from artemis.infra.utils.llm_text import strip_thinking
...
if TYPE_CHECKING:
    ...
    from artemis.infra.db.repos.thread_messages import ThreadMessageInput
