"""Setup wizard password file at ``<home>/artemis-login.txt``."""
...
WIZARD_FILE_NAME = "artemis-login.txt"
_TOKEN_BYTES = 16
...
def boot_self_heal(home: Path, user_count: int) -> str | None:
    ...
    already exists (e.g. the DB was wiped but ``artemis-login.txt`` was not).
