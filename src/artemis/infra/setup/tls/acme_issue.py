...
from artemis.infra.setup.tls.store import account_key_path
from artemis.infra.utils.paths import PathLayout, ensure_private_dir
...
def issue_certificate_http01(
    *,
    ...
    net = ClientNetwork(account_key, user_agent="artemis/0.1")
