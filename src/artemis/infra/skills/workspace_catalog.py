"""Symlink-tolerant workspace skill discovery for Artemis."""
...
from artemis.infra.agents.workspace_dir import skills_discovery_roots
...
def list_workspace_skill_summaries(
    ...
    *,
    ...
    """Scan ``skills/`` including ``.artemis/skills`` and symlinked directories."""
    seen: set[str] = set()
