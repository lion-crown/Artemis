"""Read Artemis DB provider rows and build harness ``ProviderConfig`` objects."""
...
from artemis.infra.agents.providers.model_flags import is_chat_eligible_model, is_vision_model
from artemis.infra.agents.providers.opencode_session import (
