...
from artemis.infra.agents.providers import KIND_TO_PROTOCOL
from artemis.infra.agents.providers.opencode_session import ensure_opencode_session_header
...
def _should_probe_embedding(row: Any, *, model_id: str, embedding: bool | None) -> bool:
    if embedding is True:
        return True
    from artemis.infra.agents.providers.model_flags import is_embedding_model
...
def _friendly_probe_error(exc: BaseException | str, *, locale: str) -> str:
    ...
    from artemis.i18n.domains.stream import stream_error_message
...
async def probe_provider_row(
    ...
    *,
    ...
    from artemis.infra.agents.providers.model_flags import is_onnx_local_provider
    ...
    if is_onnx_local_provider(
        ...
        from artemis.infra.agents.providers.onnx_service import probe_local_model
