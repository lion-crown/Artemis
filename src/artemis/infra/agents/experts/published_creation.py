...
from artemis.infra.agents.avatar import bind_workspace_avatar_icon_url
...
def require_published_expert(services: Any, expert_id: str) -> PublishedExpertRow:
    ...
    if row is None:
        raise ArtemisError(ErrorCode.NOT_FOUND, f"published expert {expert_id!r} not found")
...
async def install_published_expert(
    *,
    ...
    if not snapshot_dir.is_dir():
        raise ArtemisError(ErrorCode.NOT_FOUND, f"published expert {expert_id!r} snapshot not found")
