...
from artemis.infra.connectors.oauth.mcp import fetch_authorization_metadata
from artemis.infra.utils.ssrf_guard import UnsafeOutboundUrl, safe_request, validate_https_url
        ...
        resp = await safe_request(
            ...
            json={
                ...
                "params": {
                    ...
                    "capabilities": {},
                    "clientInfo": {"name": "artemis", "version": "0.1"},
                },
            },
