...
from artemis.i18n.domains.attachment import attachment_empty_image
from artemis.infra.agents.context_breakdown import usage_dict_from_message
...
from artemis.infra.utils.llm_text import strip_thinking as _strip_thinking
    ...
    *,
    ...
    try:
        ...
        if not raw:
            ...
            raw = session_rows
        from artemis.infra.gateway.process.history_projection import message_inputs  # noqa: PLC0415
...
def _enrich_history_tool_media(
    ...
    *,
    ...
    from artemis.infra.gateway.media.tool_media import enrich_tool_output_string_sync  # noqa: PLC0415
