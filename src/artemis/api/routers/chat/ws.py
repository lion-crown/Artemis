...
from artemis.api.deps import resolve_user_from_token
from artemis.api.routers.chat.models import UserTurnWsFrame
from artemis.api.routers.chat.sse import json_chunk_default
...
async def dashboard_chat_ws(
    ...
    try:
        ...
        from artemis.infra.errors import ErrorCode  # noqa: PLC0415
