...
from artemis.api.routers.ollama_download_store import (
    DownloadTask,
    DownloadTaskStatus,
    cancel_task,
    clear_completed,
...
async def _run_pull_in_background(
    ...
    from artemis.infra.utils.ollama_manager import OllamaModelInfo, OllamaModelManager
...
class OllamaServiceBody(BaseModel):
    enabled: bool = Field(..., description="Whether Artemis should keep the Ollama service running")
...
async def get_ollama_service(
    ...
    from artemis.infra.utils.ollama_manager import is_ollama_reachable
...
async def put_ollama_service(
    ...
    from artemis.infra.utils.ollama_manager import (
        is_ollama_reachable,
