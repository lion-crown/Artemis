...
from artemis.api.common.memory_client import memory_db_path_for_cfg, memory_namespace
...
async def pack_agent_memory(
    ...
    try:
        ...
        raise ArtemisError(ErrorCode.INTERNAL_ERROR, "harness-memory 未安装") from None
    except ValueError as exc:
        raise ArtemisError(ErrorCode.INTERNAL_ERROR, str(exc), status=400) from exc
    except Exception as exc:
