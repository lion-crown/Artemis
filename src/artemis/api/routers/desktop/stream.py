...
from artemis.infra.desktop.input import canvas_to_screen, run_desktop_action
    ...
    *,
    ...
    while ws.application_state == WebSocketState.CONNECTED:
        ...
        if payload:
            ...
            if miss_streak >= 30:
                err = ArtemisError.localized(ErrorCode.DESKTOP_CAPTURE_FAILED, locale)
                await _send_json(
                    ws,
                    {
                        "type": "error",
