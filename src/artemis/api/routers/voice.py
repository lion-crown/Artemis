...
from artemis.infra.voice.manager import VoiceManager
from artemis.infra.voice.presets import load_voice_presets
...
async def transcribe_audio(
    ...
    if not data:
        raise ArtemisError(ErrorCode.SLASH_BAD_ARGS, "audio file is empty")
