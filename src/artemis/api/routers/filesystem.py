...
from artemis.infra.users.resource_policy import POLICY_WORKSPACE_ROOT_DIR, workspace_root_dir_of
from artemis.infra.utils.bwrap import ensure_bubblewrap
from artemis.infra.utils.docker_env import docker_status, ensure_docker
...
async def probe_host_dir(
    ...
    """Check whether Artemis can use *path* as a local backend root_dir."""
    allowed = _user_workspace_root(server, user)
