...
#   bash docker/docker_build.sh myreg/artemis:v1
#   bash docker/docker_build.sh artemis:dev --no-cache
#
...
echo ""
echo "启动示例:"
echo "  docker run -d -p 8088:8088 -v artemis-data:/data/.artemis -e HOME=/data ${IMAGE_TAG}"
echo ""
echo "或使用 Compose:"
