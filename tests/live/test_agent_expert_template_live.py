...
Uses bundled templates under ``src/artemis/infra/agents/experts/library/`` (exported
...
from artemis.infra.agents.experts.catalog import Expert, ExpertCatalog, default_library_root
