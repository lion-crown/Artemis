"""Compose must forward ARTEMIS_DATABASE_* into the container (issue #152)."""

from __future__ import annotations

from pathlib import Path

from artemis.config import _DATABASE_ENV_KEYS


def _compose_environment_entries(compose_text: str) -> str:
    """Return list-item lines under the artemis service ``environment:`` key."""
    marker = "\n    environment:\n"
