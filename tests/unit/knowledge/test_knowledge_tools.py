...
from artemis.infra.knowledge.tools import build_knowledge_tools
...
async def test_search_knowledge_returns_retrieved_context() -> None:
    ...
    with (
        ...
        patch("artemis.infra.knowledge.tools.retrieve_context", retrieved),
    ):
...
async def test_search_knowledge_empty_hits_message() -> None:
    ...
    with (
        ...
        patch(
            "artemis.infra.knowledge.tools.retrieve_context",
