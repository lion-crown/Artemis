...
from artemis.infra.agents.plugin_tool_names import (
...
def test_expand_plugin_tools_default_on_without_agent_config() -> None:
    """Artemis default-on expansion makes tools bind without an agent opt-in."""
    from artemis.infra.agents.plugin_tool_defaults import expand_plugin_tools_default_on
