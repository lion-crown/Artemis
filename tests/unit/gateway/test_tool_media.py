...
from artemis.infra.gateway.media.constants import INBOUND_DIR, OUTBOUND_DIR
...
def _default_virtual_workspace(root: str) -> BackendWorkspace:
    """BackendWorkspace matching Artemis's platform default agent backend.
...
def test_dashboard_media_url_uses_path_agent_id() -> None:
    from artemis.infra.gateway.media.backend_files import dashboard_media_url

    path = "file:///Users/me/.artemis/agents/W4MFVJ/outbound/screenshots/harness.png"
...
async def test_resolve_preview_keeps_host_absolute_screenshot() -> None:
    ...
    from artemis.infra.gateway.media.backend_files import resolve_preview_payload
...
async def test_enrich_plain_text_screenshot_output() -> None:
    from artemis.infra.gateway.media.tool_media import enrich_tool_output_string

    text = (
        "Screenshot saved to /Users/me/.artemis/agents/A1/outbound/screenshots/harness.png "
        "(116 KB, 1440x900)"
    )
