...
from artemis.infra.gateway.media.tool_media import enrich_media_block_preview
from artemis.infra.gateway.ws import WS_CHANNEL_ID, WebSocketChannel, WebSocketHub
...
async def test_global_processor_iter_turn_chunks_registers_hitl() -> None:
    ...
    from artemis.infra.gateway.hitl.coordinator import HitlChannelCoordinator
...
async def test_global_processor_iter_turn_chunks_slash(tmp_path: Path) -> None:
    ...
    from artemis.infra.gateway.process.processor import GlobalProcessor
    from artemis.infra.gateway.slash.dispatcher import build_default_dispatcher
