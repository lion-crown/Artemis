...
from artemis.infra.gateway.media.tool_media import iter_media_blocks
from artemis.infra.gateway.process import (
    build_content,
...
async def test_block_to_content_part_base64_image():
    ...
    from artemis.infra.gateway.media.tool_media import block_to_content_part
