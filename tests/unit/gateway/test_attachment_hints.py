...
from artemis.api.routers.chat.models import ChatTurnBody
from artemis.api.routers.chat.turn import (
    COMPOSER_CTX_KEY,
    INBOUND_ATTACHMENTS_KEY,
    build_dashboard_inbound,
    content_parts_from_dashboard_turn,
)
from artemis.infra.gateway.media.attachment_hints import (
    VISION_MAX_BYTES,
...
from artemis.infra.gateway.media.inbound_store import (
...
def test_build_dashboard_inbound_uses_content_parts_not_messages_meta() -> None:
    from artemis.api.routers.chat.turn import PreparedDashboardTurn
