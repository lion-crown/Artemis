...
from artemis.infra.utils.llm_text import llm_text_content as _llm_text_content
...
def test_split_string_thinking_parses_redacted_block() -> None:
    from artemis.api.routers.chat.serialize import _split_string_thinking
...
def test_load_projected_falls_back_to_created_at() -> None:
    ...
    from artemis.api.routers.chat.serialize import _load_projected_thread_messages
...
_PLACEHOLDER_TEXT = (
    ...
    "path=C:\\Users\\me\\.artemis\\agents\\DMQ318\\.media-cache/"
...
def test_serialize_history_message_drops_zip_path_hint() -> None:
    ...
    hint = (
        "[附件] report.zip\n"
        "工作区路径：/.artemis/workspaces/JRK846/inbound/1_report.zip\n"
...
async def test_load_checkpoint_messages_falls_back_to_graph_state() -> None:
    from artemis.api.routers.chat.serialize import _load_checkpoint_messages
