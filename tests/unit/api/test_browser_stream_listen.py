...
from artemis.api.routers.browser import stream as stream_mod
from artemis.api.routers.browser.harness import resolve_harness_session
...
async def test_resolve_harness_session_create_true_rejects_empty_hint() -> None:
    ...
    with (
        ...
        pytest.raises(ArtemisError, match="browser profile is required"),
    ):
