...
from artemis.infra.agents.middleware.workspace_image import WorkspaceImageMaterializeMiddleware
from artemis.infra.gateway.media.attachment_hints import make_workspace_image_ref
