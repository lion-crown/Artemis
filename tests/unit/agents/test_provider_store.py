"""Unit tests for :mod:`artemis.infra.agents.providers.store`."""
...
from artemis.infra.agents.providers import KIND_TO_PROTOCOL, ProviderStore
...
def test_enabled_model_refs_excludes_disabled() -> None:
    from artemis.infra.agents.providers.store import enabled_model_refs
