...
def test_preview_file_paths_limits_dashboard_preview(tmp_path: Path) -> None:
    from artemis.infra.agents.experts.catalog import ExpertCatalog, preview_file_paths
...
def test_preview_paths_skip_manifest_json_in_prompt_files(tmp_path: Path) -> None:
    from artemis.infra.agents.experts.catalog import preview_paths_from_inventory
