...
_SPEC = importlib.util.spec_from_file_location("artemis_desktop_stamp_version", _STAMP)
...
def test_stamp_manifest_sets_artemis_identity_only(tmp_path: Path) -> None:
    src = (
    ...
    assert 'name="com.tencent.artemis" version="1.2.3.0"' in text
