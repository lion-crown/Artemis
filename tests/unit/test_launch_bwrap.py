"""Tests for non-blocking bubblewrap provisioning in ``artemis run``."""
...
def test_background_ensure_swallows_failures(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("artemis.infra.utils.bwrap.ensure_bubblewrap", fail)
