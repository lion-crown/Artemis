...
from artemis.infra.backend.browse import list_storage_backend_tree
from artemis.infra.backend.probe import row_for_probe
...
async def test_list_storage_backend_tree_docker_lists_and_closes(
    ...
    monkeypatch.setattr(
        "artemis.infra.backend.browse.resolve_storage_backend",
...
async def test_list_storage_backend_tree_maps_runtime_errors(
    ...
    monkeypatch.setattr(
        "artemis.infra.backend.browse.resolve_backend",
