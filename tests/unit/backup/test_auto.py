...
from artemis.config import BackupConfig, load_config
...
def test_to_auto_backup_filename() -> None:
    assert (
        to_auto_backup_filename("artemis-backup-20260101T000000Z.tar.gz")
        == "artemis-auto-backup-20260101T000000Z.tar.gz"
    )
    assert (
        to_auto_backup_filename("artemis-auto-backup-20260101T000000Z.tar.gz")
        == "artemis-auto-backup-20260101T000000Z.tar.gz"
    )
