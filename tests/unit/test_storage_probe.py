...
from artemis.infra.backend.probe import _docker_probe_spec, probe_storage_backend
...
class _FakeRead:
    error = None
    file_data = {"content": "artemis-docker-probe"}
...
def test_opensandbox_probe_installs_and_closes(monkeypatch: pytest.MonkeyPatch) -> None:
    from artemis.infra.backend import opensandbox_deps
    from artemis.infra.backend import probe as probe_mod
