...
from artemis.infra.agents.providers.probe import fetch_openai_compatible_models
...
async def test_fetch_models_parses_openai_list() -> None:
    ...
    with patch("artemis.infra.agents.providers.probe.httpx.AsyncClient", return_value=mock_client):
