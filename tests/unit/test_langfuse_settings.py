...
from artemis.infra.agents.langfuse import LangfuseSettingsStore, verify_langfuse_credentials
...
def test_verify_langfuse_credentials_accepts_legacy_project_shape() -> None:
    payload = json.dumps({"data": [{"id": "proj-1", "name": "artemis", "metadata": {}}]}).encode()
