...
End-to-end smoke: build a real ArtemisServer with a main agent, seed a
small graph (entity / candidate / atom / episode / journal) directly
into the agent memory SQLite (``.artemis/memory.sqlite`` for new agents)
...
from artemis.api.common.memory_client import (
