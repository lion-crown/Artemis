...
async def test_list_localizes_artemis_presentation_metadata(env: Any) -> None:
    c, _srv, auth, aid = env
    content = """---
name: pdf-reader
...
async def test_artemis_skill_manager_detail_and_delete_protection(env: Any) -> None:
    c, _srv, auth, aid = env
