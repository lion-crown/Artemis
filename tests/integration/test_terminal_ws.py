...
def test_extract_winsize_helper_packs_in_correct_order() -> None:
    ...
    from artemis.api.routers.terminal import _set_winsize  # noqa: F401  (existence)
...
def test_detect_shell_returns_existing_path() -> None:
    ...
    from artemis.api.routers.terminal import _detect_shell
...
def test_read_nonblock_returns_empty_for_none_fd() -> None:
    from artemis.api.routers.terminal import _read_nonblock
