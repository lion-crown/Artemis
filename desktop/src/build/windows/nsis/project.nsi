...
# Artemis desktop NSIS installer.
# Built by `wails3 task package` on a Windows runner:
#   makensis -DARG_WAILS_AMD64_BINARY=..\..\..\bin\Artemis.exe project.nsi
#   makensis -DARG_WAILS_ARM64_BINARY=..\..\..\bin\Artemis.exe project.nsi
