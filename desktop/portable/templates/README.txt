Artemis green portable package
============================

Extract this zip anywhere. It includes a portable CPython runtime and Artemis
...
Defaults: http://127.0.0.1:8088   data dir = ./data (ARTEMIS_HOME)

  ./start.sh --home /path/to/data --host 127.0.0.1 --port 8088

First launch follows the normal Artemis setup wizard (create admin password).

Layout
------
  runtime/     portable CPython
  packages/    Artemis + locked dependencies (site-packages)
