#!/usr/bin/env bash
# Build one native Artemis desktop release: Dashboard → portable runtime → Wails package.
...
rebuilding desktop/portable/release/Artemis-portable-<platform>-<version>.zip when it already exists.
EOF
}
...
staging="${REPO_ROOT}/desktop/portable/release/Artemis-${plat}"
