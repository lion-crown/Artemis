...
$DashboardDest = Join-Path $RepoRoot "src\artemis\dashboard"
...
if (-not (Test-Path $indexHtml)) {
    throw "Dashboard build did not produce src/artemis/dashboard/index.html"
}

Write-Host "[wheel_build] Dashboard ready at src/artemis/dashboard/"
