...
const ArtemisAdminUsersPage = lazy(() => import("../pages/Admin/Users"));
...
export const routeConfigs: RouteConfig[] = [
  ...
  { path: "/admin/users", element: <ArtemisAdminUsersPage /> },
  {
    path: "/admin/sso",
  ...
  {
    path: "/admin/plugins",
    element: <Navigate to="/experts" replace />,
  },
  ...
  { path: "/artemis/cron", element: <Navigate to="/tasks" replace /> },
  { path: "/artemis/channels", element: <Navigate to="/channels" replace /> },
  {
    path: "/artemis/admin/users",
    element: <Navigate to="/admin/users" replace />,
  },
  {
    path: "/artemis/admin/audit",
    element: <Navigate to="/admin/security?tab=audit" replace />,
  },
  {
  ...
  { path: "/plugins", element: <Navigate to="/experts" replace /> },
