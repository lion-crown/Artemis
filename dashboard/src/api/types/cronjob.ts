...
// ---------------------------------------------------------------------------
// Artemis-native flat cron row — returned by /api/agents/:id/cron endpoints
// ---------------------------------------------------------------------------

/**
 * Wire-shape returned by Artemis's per-agent cron endpoints.
 * Matches the Python ``_row_to_dict`` serializer in ``api/routers/cron.py``.
 */
export interface ArtemisCronRow {
  id: string;
  name: string;
  agent_id: string;
  trigger: string;
...
export interface ArtemisCronCreateBody {
  name?: string | null;
  trigger: string;
  prompt: string;
...
export interface ArtemisCronPatchBody {
  name?: string | null;
  trigger?: string;
  prompt?: string;
  session_key?: string | null;
