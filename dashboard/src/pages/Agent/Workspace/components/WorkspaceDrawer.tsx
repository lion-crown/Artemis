...
function isProtectedPath(path: string): boolean {
  return (
    ...
    path === "/.artemis/_builtin_skills" ||
    path.startsWith("/.artemis/_builtin_skills/")
  );
}
...
const TREE_COLLAPSED_KEY = "artemis:workspace-drawer-tree-collapsed";
...
export default function WorkspaceDrawer({
  ...
  const { size: treeWidth, onResizeStart } = useHorizontalResize({
    ...
    max: 420,
    defaultSize: 240,
    storageKey: "artemis:workspace-drawer-tree-width",
  });
