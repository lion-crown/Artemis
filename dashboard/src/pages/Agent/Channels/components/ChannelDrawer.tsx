...
export interface ChannelFormValues {
  ...
  delivery_mode?: "stream" | "final_only";
...
function DisplaySettingsFields() {
  ...
  return (
    <div className={styles.displaySettings}>
      ...
      {kind === "wecom" && (
        <Form.Item name="delivery_mode" label={t("channels.wecomDeliveryMode")}>
          <Segmented
            options={[
              { label: t("channels.wecomDeliveryStream"), value: "stream" },
              {
                label: t("channels.wecomDeliveryFinalOnly"),
                value: "final_only",
              },
            ]}
          />
    ...
    >
      {loadingConfig ? (
        ...
        >
          ...
          {(configMode === "manual" || isEdit || !supportsQuickConfig) && (
            <>
              {(introUrl || selectedKind === "artemisbot") && (
              ...
              >
                <Select
                  ...
                  options={[
                    ...
                    ...(isEdit &&
                    selectedKind &&
                    !CHANNEL_SELECTABLE_KEYS.includes(selectedKind)
                      ? [selectedKind]
                      : []),
                  ].map((k) => ({
                    value: k,
