 ...
 *
 * Drives artemis's ``/agents/{aid}/channels`` CRUD + ``/test`` endpoints with
 * compatibility state management (loading flag, in-place optimistic updates,
 * antd ``message`` toasts). Drop-in replacement for the former flat-config
