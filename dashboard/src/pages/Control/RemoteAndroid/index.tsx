...
const MOBILE_AI_PANEL_KEY = "artemis:remote-phone:ai-panel-open";
const MOBILE_AI_PANEL_WIDTH_KEY = "artemis:remote-phone:ai-panel-width";
const MOBILE_AI_PANEL_HEIGHT_KEY = "artemis:remote-phone:ai-panel-height";
...
const SHELL_SPLIT_WIDTH_KEY = "artemis:remote-phone:shell-split-width";
const SHELL_SPLIT_MIN_WIDTH = 280;
const SHELL_SPLIT_MAX_WIDTH = 720;
const SHELL_SPLIT_DEFAULT_WIDTH = 420;
const SHELL_PANEL_OPEN_KEY = "artemis:remote-phone:shell-panel-open";
const STREAM_QUALITY_KEY = "artemis:remote-phone:stream-quality";
...
export default function RemoteAndroidPage({
  ...
  const {
    ...
    storageKey: "artemis:remote-phone:view-tab",
    defaultTab: "screen",
  });
  ...
  const handleScreenshot = useCallback(() => {
    ...
    try {
      ...
      a.href = url;
      a.download = `artemis-phone-${device || "screen"}-${Date.now()}.png`;
      a.click();
    } catch {
