...
export function CronJobCard({
  ...
  const lastStatus =
    typeof meta.artemis_last_status === "string" ? meta.artemis_last_status : null;
  const lastError =
    typeof meta.artemis_last_error === "string" ? meta.artemis_last_error : null;
  const lastRunAt =
    typeof meta.artemis_last_run_at === "number" ? meta.artemis_last_run_at : null;
