...
export const createColumns = (
  ...
  return [
    ...
    },
    {
      ...
      render: (_: unknown, record: CronJob) => {
        const meta = (record.meta as Record<string, unknown> | undefined) ?? {};
        const ts = meta.artemis_last_run_at;
        return (
    ...
    },
    {
      ...
      render: (_: unknown, record: CronJob) => {
        const meta = (record.meta as Record<string, unknown> | undefined) ?? {};
        const status = meta.artemis_last_status;
        const lastError =
          typeof meta.artemis_last_error === "string"
    ...
    },
    {
      ...
      render: (_: unknown, record: CronJob) => {
        const meta = (record.meta as Record<string, unknown> | undefined) ?? {};
        const fresh = Boolean(meta.artemis_fresh_thread);
        return (
