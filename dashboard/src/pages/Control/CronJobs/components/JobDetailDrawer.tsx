...
export function JobDetailDrawer({
  ...
  const sessionKey =
    typeof meta.artemis_session_key === "string" ? meta.artemis_session_key : "";
  ...
  const lastStatus =
    typeof meta.artemis_last_status === "string" ? meta.artemis_last_status : "";
  const lastError =
    typeof meta.artemis_last_error === "string" && meta.artemis_last_error.trim()
      ? meta.artemis_last_error
      : null;
    ...
    >
      ...
      >
        ...
        <Descriptions.Item label={t("cronJobs.col.lastRunAt")}>
          {formatCronTimestamp(
            typeof meta.artemis_last_run_at === "number"
              ? meta.artemis_last_run_at
              : null,
            timeZone,
          )}
        </Descriptions.Item>
