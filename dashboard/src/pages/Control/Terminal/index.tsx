...
const AI_PANEL_LAYOUT_KEY = "artemis:terminal-ai-layout";
const AI_PANEL_WIDTH_KEY = "artemis:terminal-ai-width";
const AI_PANEL_HEIGHT_KEY = "artemis:terminal-ai-height";
