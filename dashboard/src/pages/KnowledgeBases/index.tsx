...
const DOCS_VIEW_STORAGE_KEY = "artemis:knowledge-bases-docs-view";
...
export default function KnowledgeBasesPage() {
  ...
  const togglePreviewFullscreen = useCallback(() => {
    ...
    ) ?? document.querySelector<HTMLElement>(".artemis-modal-content")) as
      | (HTMLElement & {
  ...
  const {
    ...
    max: 480,
    defaultSize: 280,
    storageKey: "artemis:knowledge-bases:sidebar-width",
  });
  const { collapsed: listPanelCollapsed, toggle: toggleListPanel } =
    useListPanelCollapsed("artemis:knowledge-bases:list-collapsed");
