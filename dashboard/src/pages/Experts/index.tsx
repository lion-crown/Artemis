...
const VIEW_STORAGE_KEY = "artemis:experts-view";
...
function installedExpertIdsFromAgents(
  agents: Pick<ArtemisAgent, "template_name" | "config">[],
): Set<string> {
...
export default function ExpertsPage() {
  ...
  const [localAgents, setLocalAgents] = useState<ArtemisAgent[]>(ownedAgents);
