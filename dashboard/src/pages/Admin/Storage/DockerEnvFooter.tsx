 ...
 *
 * Three install paths: auto / manual script / Artemis agent prompt.
 */
...
export function DockerEnvFooter() {
  ...
  return (
    <div className={styles.drawerPanel}>
      ...
      {/* 3. Artemis agent install */}
      <section className={styles.section}>
        <div className={styles.sectionTitle}>
          {t("storage.dockerEnv.sectionArtemis")}
        </div>
        <p className={styles.sectionDesc}>{t("storage.dockerEnv.artemisDesc")}</p>
        {env?.agent_prompt ? (
