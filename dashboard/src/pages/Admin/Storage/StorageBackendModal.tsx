    ...
    if (open) {
      if (editing) {
        ...
        if (kind === "docker") {
          ...
          form.setFieldValue("sandbox_prefix", "artemis_sandbox");
        }
        if (kind === "opensandbox") {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (values.kind === "docker") {
        ...
        cfg.sandbox_prefix =
          (values.sandbox_prefix || "artemis_sandbox").trim() || "artemis_sandbox";
        ...
        {activeKind === "docker" && (
          <>
            ...
            <Form.Item
              ...
              initialValue="artemis_sandbox"
            >
              <Input placeholder="artemis_sandbox" />
            </Form.Item>
            {sandboxScope === "fixed" && (
              <Form.Item
                name="sandbox_id"
