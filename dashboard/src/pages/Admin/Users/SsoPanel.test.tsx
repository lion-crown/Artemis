...
describe("<SsoPanel />", () => {
  ...
  it("loads the provider configuration and displays its callback URL", async () => {
    getOidcConfig.mockResolvedValue({
      ...
      dashboard_origin: "https://artemis.example.com",
      has_client_secret: true,
      redirect_uri: "https://artemis.example.com/api/auth/oidc/callback",
    });
    ...
    expect(
      screen.getByDisplayValue(
        "https://artemis.example.com/api/auth/oidc/callback",
      ),
    ).toBeInTheDocument();
