...
describe("parseKnowledgeCitations", () => {
  ...
  it("extracts citations and strips the marker", () => {
    const raw =
      'passages\n\n<!--artemis-kb-citations:[{"kb_id":"kb1","kb_name":"Docs","doc_id":"d1","filename":"a.md"}]-->';
  ...
  it("dedupes by doc id", () => {
    const raw =
      'x<!--artemis-kb-citations:[{"doc_id":"d1","filename":"a.md"},{"doc_id":"d1","filename":"a.md"}]-->';
    expect(parseKnowledgeCitations(raw).citations).toHaveLength(1);
  });

  it("parses optional path", () => {
    const raw =
      'x<!--artemis-kb-citations:[{"kb_id":"kb1","kb_name":"Docs","doc_id":"d1","filename":"a.md","path":"notes/a.md"}]-->';
  ...
  it("omits path when absent", () => {
    const raw =
      'x<!--artemis-kb-citations:[{"doc_id":"d1","filename":"a.md"}]-->';
