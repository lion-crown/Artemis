...
import { ArtemisEmptyMascot } from "./ArtemisEmptyMascot";
...
interface EmptyStateProps {
   ...
   * - empty: inbox icon
   * - error: alert icon
   * - mascot: shared Artemis empty mascot (prefer for list/detail empty shells)
   */
...
export { ArtemisEmptyMascot } from "./ArtemisEmptyMascot";
export { ARTEMIS_EMPTY_MASCOT_SRC } from "../../assets/mascot";
