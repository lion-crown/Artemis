 ...
 *
 * Examples:
 *   file:///home/wally/.artemis/workspace/foo.png  → /api/workspace/media?path=foo.png
 *   /home/wally/.artemis/workspace/sub/bar.jpg     → /api/workspace/media?path=sub/bar.jpg
 *
...
function resolveImageSrc(src: string): string {
  ...
  // Match workspace path: ends in /.artemis/workspace/<rest>
  const workspaceMatch = filePath.match(/[/\\]\.artemis[/\\]workspace[/\\](.*)/);
  if (workspaceMatch) {
