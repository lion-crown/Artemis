...
const SIDEBAR_COLLAPSED_KEY = "artemis:sidebar:collapsed";
...
export default function MainLayout() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("artemis:toggle-nav", handler);
    return () => window.removeEventListener("artemis:toggle-nav", handler);
  }, []);
  ...
  useEffect(() => {
    document.documentElement.classList.toggle("artemis-chat-open", isChatRoute);
    return () => {
      document.documentElement.classList.remove("artemis-chat-open");
    };
  }, [isChatRoute]);
